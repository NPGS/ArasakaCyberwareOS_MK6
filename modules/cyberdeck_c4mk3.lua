...
if TweakDB:GetRecord("Items.MilitechParalineEpicMKIII") == nil then
    ...
    -- VENDOR
    TweakDB:CloneRecord("Vendors.wat_lch_ripperdoc_01_inline51", "Vendors.wat_lch_ripperdoc_01_inline15")
    TweakDB:SetFlat("Vendors.wat_lch_ripperdoc_01_inline51.item", "Items.MilitechParalineEpicMKIII")
    addToList("Vendors.wat_lch_ripperdoc_01.itemStock", "Vendors.wat_lch_ripperdoc_01_inline51")
