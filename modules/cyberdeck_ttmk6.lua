...
if TweakDB:GetRecord("Items.TetratronicLegeMK6") == nil then
    TweakDB:CloneRecord("Items.TetratronicLegeMK6", "Items.TetratronicRipplerLegendaryMKIV")    -- ITEM
        TweakDB:CloneRecord("Items.TetratronicLegeMK6_inline0", "Items.TetratronicRipplerLegendaryMKIV_inline1")    -- LOGIC
            Ti200.cloneConstantStat("Items.TetratronicLegeMK6_inline1", "Items.TetratronicRipplerLegendaryMKIV_inline2", 16)    -- RAM
            Ti200.cloneConstantStat("Items.TetratronicLegeMK6_inline2", "Items.TetratronicRipplerLegendaryMKIV_inline3", 12)    -- BUFFER
        Ti200.cloneConstantStat("Price.Cyberdeck_TetratronicMK6", "Price.Cyberdeck", 20)  -- PRICE
    ...
    -- SERVICE
    Ti200.createVendorItem("Vendors.TetratronicRipplerMK6","Vendors.DowntownCredAvailability","Items.TetratronicLegeMK6","Vendors.bls_ina_se1_ripperdoc_01.itemStock")    -- VENDOR
    Ti200.arrayInsert("Debug.CW_Cyberdecks.items", "Items.TetratronicLegeMK6")    -- DEBUG
end
