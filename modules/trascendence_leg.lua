...
if TweakDB:GetRecord("Items.SpecialSandevistanFragment2") == nil then
    TweakDB:CloneRecord("Items.SpecialSandevistanFragment2", "Items.SandevistanFragment1")  -- Item
        TweakDB:CloneRecord("Items.SpecialSandevistanFragment2_inline0", "Items.SandevistanFragment1_inline0")  -- Logic
            ...
            createConstantStat("Items.SpecialSandevistanFragment2_inline2", 'Multiplier', "BaseStats.TimeDilationSandevistanTimeScale", 0.75)   -- Time Dilation
            createConstantStat("Items.SpecialSandevistanFragment2_inline3", 'Multiplier', "BaseStats.TimeDilationSandevistanDuration", 0.75)  -- Reduced Duration
    ...
    -- SERVICE
    createVendorItem("Vendors.cct_dtn_ripdoc_01_trascendence","Vendors.StreetCredAvailability","Items.SpecialSandevistanFragment2","Vendors.cct_dtn_ripdoc_01.itemStock")   -- VENDOR
    arrayInsert("Debug.CyberwareFragments.items", "Items.SpecialSandevistanFragment2")  -- DEBUG
end
