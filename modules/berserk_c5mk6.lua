...
TweakDB:SetFlat("Items.BerserkC5MK6.displayName", LocKey("ArasakaBerserkMK6-Name"))
TweakDB:SetFlat("Items.BerserkC5MK6.localizedDescription", LocKey("ArasakaBerserkMK6-Desc"))
