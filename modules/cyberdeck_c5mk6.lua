...
if TweakDB:GetRecord("Items.ArasakaPhantomLegendaryMKVI") == nil then
    TweakDB:CloneRecord("Items.ArasakaPhantomLegendaryMKVI", "Items.ArasakaLegendaryMKIV")   -- item
        TweakDB:CloneRecord("Items.ArasakaPhantomLegendaryMKVI_inline0", "Items.ArasakaLegendaryMKIV_inline0")   -- logic package
            Ti200.cloneConstantStat("Items.ArasakaPhantomLegendaryMKVI_inline1", "Items.ArasakaLegendaryMKIV_inline1", 16)   -- ram memory size
            Ti200.cloneConstantStat("Items.ArasakaPhantomLegendaryMKVI_inline2", "Items.ArasakaLegendaryMKIV_inline2", 12)   -- buffer size
        Ti200.cloneConstantStat("Price.Cyberdeck_ArasakaMKVI", "Price.Cyberdeck", 22.5)   -- price
    ...
    -- SERVICE
    Ti200.createVendorItem("Vendors.pac_wwd_ripperdoc_01_phantom_mk6","Vendors.DowntownCredAvailability","Items.ArasakaPhantomLegendaryMKVI","Vendors.pac_wwd_ripperdoc_01.itemStock")    -- VENDOR
    Ti200.arrayInsert("Debug.CW_Cyberdecks.items", "Items.ArasakaPhantomLegendaryMKVI")
end
