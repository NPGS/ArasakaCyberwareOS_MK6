...
TweakDB:SetFlat("Items.SandevistanC4MK6.displayName", LocKey("MilitechSandevistanMK6-Name"))
...
TweakDB:SetFlat("Items.SandevistanC4MK6.localizedDescription", LocKey("MilitechSandevistanMK6-Desc"))
